...
- [#362](https://github.com/nf-core/epitopeprediction/pull/362) Nearby somatic missense variants on the same transcript are also combined into one mutant sequence (assumed in cis), so multi-variant peptides are generated alongside the single-variant ones ([@axelwalter](https://github.com/axelwalter/))
