...
- [#334](https://github.com/nf-core/epitopeprediction/issues/334) Added `--speclib_output` parameter to generate predicted spectral libraries using AlphaPeptDeep ([@jonasscheid](https://github.com/jonasscheid/))
