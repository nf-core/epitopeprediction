...
```bash
nextflow run nf-core/epitopeprediction --input '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/epitopeprediction`](https://hub.docker.com/r/nfcore/epitopeprediction/)
* `singularity`
