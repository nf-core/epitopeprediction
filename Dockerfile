...
ENV PATH /opt/conda/envs/nf-core-epitopeprediction-1.1.0dev/bin:$PATH

# Dump the details of the installed packages to a file for posterity
RUN conda env export --name nf-core-epitopeprediction-1.1.0dev > nf-core-epitopeprediction-1.1.0dev.yml
